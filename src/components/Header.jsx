  ...
  return (
    <header className="header">
      <nav className="navbar">
        <a onClick={() => scrollTo("page-hero")} href="#/" className="nav-branding">
          Cory Marker
        </a>
        ...
        >
          ...
          <li className="nav-item">
            <a onClick={() => scrollTo("projects")} href="#/projects" className="nav-link">
              Projects
            </a>
          </li>
          <li className="nav-item">
            <a onClick={() => scrollTo("skills")} href="#/skills" className="nav-link">
              Skills
            </a>
          </li>
          <li className="nav-item">
            <a onClick={() => scrollTo("contact")} href="#/contact" className="nav-link">
              Contact
            </a>
          </li>
        </ul>
